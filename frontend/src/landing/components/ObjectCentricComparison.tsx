        ...
        <div className="rounded-2xl border border-[#E4E4E7] bg-[#F7F7F2] p-4 sm:p-8 shadow-xs">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-6 border-b border-[#E4E4E7]">
            <div className="flex items-center gap-2">
              ...
              <div
                className="inline-flex rounded-lg border border-[#E4E4E7] bg-white p-1 shadow-2xs"
                role="group"
              ...
              >
                ...
                <button
                  type="button"
                  onClick={() => setViewMode("object_centric")}
                  className={`px-3.5 py-1.5 text-xs font-mono rounded-md transition-all cursor-pointer ${
          ...
          {/* Graphical Demonstration Surface */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center pt-8">
            {/* Left/Main Visual Diagram */}
            <div className="lg:col-span-8 bg-white rounded-xl border border-[#E4E4E7] p-6 shadow-2xs overflow-hidden min-h-[300px] flex items-center justify-center">
              {viewMode === "flattened" ? (
            ...
            <div className="lg:col-span-4 flex flex-col justify-center space-y-4">
              ...
              <p className="text-sm text-neutral-600 leading-relaxed font-sans">
                {viewMode === "flattened"
                  ? "Traditional process mining chooses one case notion (e.g. Order ID). All items and packages are squeezed into that single thread, creating false event orderings, duplicate events, and artificial loops when a shared worker touches different orders."
                  : "TOTeM preserves each object type's independent lifecycle. Orders, items, packages, and workers interact at shared events without forced duplication or loss of cardinality."}
              </p>

              <div className="p-3.5 rounded-lg border bg-white border-[#E4E4E7] text-xs font-mono space-y-1.5">
                <div className="text-neutral-500">Consequence:</div>
                <div className={viewMode === "flattened" ? "text-red-700 font-semibold" : "text-blue-700 font-semibold"}>
                  {viewMode === "flattened"
                    ? "× Distorted variant frequencies and phantom bottlenecks"
                    : "✓ Faithful representation of concurrent multi-object executions"}
                </div>
              </div>
            </div>
          </div>
